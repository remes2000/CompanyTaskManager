...
namespace CompanyTaskManager.Migrations
{
    ...
    [Migration("20190508103059_CreateTaskTable2")]
    partial class CreateTaskTable2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyTaskManager.Models.Task", b =>
                {
            ...
            modelBuilder.Entity("CompanyTaskManager.Models.Task", b =>
                {
                    b.HasOne("CompanyTaskManager.Models.User", "AddedBy")
                        .WithMany("AddedTasks")
                        .HasForeignKey("AddedById")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CompanyTaskManager.Models.User", "Employee")
                        .WithMany("Tasks")
